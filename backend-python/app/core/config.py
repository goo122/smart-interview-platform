...
class Settings(BaseSettings):
    ...
    xunfei_tts_app_id: str | None = None
    ...
    tts_request_timeout_seconds: float = Field(default=90.0, gt=0, le=300)
    tts_task_ttl_seconds: int = Field(default=300, ge=1, le=86400)
    tts_max_requests_per_minute: int = Field(default=30, ge=1, le=600)
    tts_max_audio_bytes: int = Field(default=5 * 1024 * 1024, ge=2, le=100 * 1024 * 1024)
    ...
    interview_preparation_task_max_attempts: int = Field(default=3, ge=1, le=10)
    interview_preparation_retry_base_seconds: float = Field(default=2.0, gt=0, le=300)
    interview_preparation_task_timeout_seconds: int = Field(default=300, ge=30, le=3600)
